class PagesController < ApplicationController
  ...
  def home
    ...
    @footprints = [
        {:name=>"Paul Allen", :percentage_in_set=> 20, :people_equivalent=> 483, :emissions_per_year => 12200, :bio=>%Q{
        ...
        {:name=>"Sergey and Larry", :percentage_in_set=> 10, :people_equivalent=> 483, :emissions_per_year => 12200, :bio=>%Q{
        ...
        {:name=>"Phil Knight", :percentage_in_set=> 30, :people_equivalent=> 483, :emissions_per_year => 12200, :bio=>%Q{
        ...
        {:name=>"Mark Cuban", :percentage_in_set=> 40, :people_equivalent=> 483, :emissions_per_year => 12200, :bio=>%Q{
        ...
        {:name=>"Rush Limbaugh", :percentage_in_set=> 40, :people_equivalent=> 483, :emissions_per_year => 12200, :bio=>%Q{
        ...
        {:name=>"Oprah Winfrey", :percentage_in_set=> 40, :people_equivalent=> 483, :emissions_per_year => 12200, :bio=>%Q{
        ...
        {:name=>"John Travolta", :percentage_in_set=> 40, :people_equivalent=> 483, :emissions_per_year => 12200, :bio=>%Q{
        ...
        {:name=>"Steve Jobs", :percentage_in_set=> 40, :people_equivalent=> 483, :emissions_per_year => 12200, :bio=>%Q{
        ...
        {:name=>"Morgan Freeman", :percentage_in_set=> 40, :people_equivalent=> 483, :emissions_per_year => 12200, :bio=>%Q{
        ...
        {:name=>"Jerry Bruckheimer", :percentage_in_set=> 40, :people_equivalent=> 483, :emissions_per_year => 12200, :bio=>%Q{
        ...
        {:name=>"Mike Bloomberg", :percentage_in_set=> 40, :people_equivalent=> 483, :emissions_per_year => 12200, :bio=>%Q{
        ...
        {:name=>"Bob Dylan", :percentage_in_set=> 40, :people_equivalent=> 483, :emissions_per_year => 12200, :bio=>%Q{
        ...
        {:name=>"Rupert Murdoch", :percentage_in_set=> 40, :people_equivalent=> 483, :emissions_per_year => 12200, :bio=>%Q{
        ...
        {:name=>"Bill Gates", :percentage_in_set=> 40, :people_equivalent=> 483, :emissions_per_year => 12200, :bio=>%Q{
